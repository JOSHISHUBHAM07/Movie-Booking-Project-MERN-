...
const SeatLayout = () => {
  ...
  // Fetch show based on route param
  const getShow = () => {
    const foundShow = dummyShowsData.find((item) => item._id === String(id));
  ...
  return (
    <div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-20 md:pt-24">
      {/* Available Timing */}
