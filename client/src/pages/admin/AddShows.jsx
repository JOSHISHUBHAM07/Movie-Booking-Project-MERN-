  ...
  return (
    <>
      ...
      <div className="mt-6">
        ...
        <div className="inline-flex gap-4 border border-gray-600 p-2 rounded-md">
          <input
            type="datetime-local"
            value={dateTimeInput}
          ...
          <button
            ...
            className="bg-primary/80 text-white px-4 py-2 text-sm rounded-lg hover:bg-primary transition"
          >
            Add Time
          </button>
        </div>
